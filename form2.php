...
<ul>
  ...
  <li><a class="active"href="http://localhost/hackathon/form2.php">Log In</a></li>
</ul>
<br><br>
...
<a href="createevent.php"><input type="submit" onsubmit="return myFunction();"  name='login' value="Log In"></a>
</center>
</form>
